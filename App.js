...
const resObj = [
  {
    ...
    analytics: {
      context: "seo-data-ac89d754-56f7-4099-a4b4-05962cd2f6f0",
    },
    cta: {
  ...
  },
  {
    info: {
      ...
      name: "Taco Bell",
      cloudinaryImageId:
        "RX_THUMBNAIL/IMAGES/VENDOR/2024/12/4/95cca2be-d63c-4c0c-9014-10ecb27e31f6_11211.JPG",
      locality: "Koramangala",
      areaName: "Koramangala",
      costForTwo: "₹300 for two",
  ...
  return (
    <div className="body">
      ...
      <div className="res-container">
        {resObj.map((restrurent) => <RestrurentCard key={restrurent.info.id} resData={restrurent}/>)}
      </div>
    </div>
  );
};
